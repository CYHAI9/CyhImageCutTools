#
#  Be sure to run `pod spec lint CyhimageCutTool.podspec' to ensure this is a
...
#DESC
  ...
  s.homepage     = "https://github.com/CYHAI9/CyhImageCutTools"
  ...
  s.source       = { :git => "https://github.com/CYHAI9/CyhImageCutTools.git", :tag => "#{s.version}" }
